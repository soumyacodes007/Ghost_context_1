# 🍕 WebPizza RAG POC (React Version)
...
> **⚠️ Experimental POC**: This is a proof-of-concept for testing purposes only. It may contain bugs and errors. React port of the original [WebPizza AI POC](https://github.com/datapizza-labs/datapizza-ai).
...
This React version maintains feature parity with the original Angular implementation:

- ✅ Same RAG pipeline and AI capabilities
- ✅ Same dual-engine support (WebLLM + WeInfer)
- ✅ Same privacy-first approach
- ✅ Built with React 18 + Vite instead of Angular 20
